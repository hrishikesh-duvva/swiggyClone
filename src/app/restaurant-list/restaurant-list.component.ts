...
export class RestaurantListComponent {
  @ViewChild('foodScroll', { static: false }) foodScroll!: ElementRef;

  scrollLeft() {
    console.log('Scrolling left');
    this.foodScroll.nativeElement.scrollBy({ left: -200, behavior: 'smooth' });
  }
  ...
  viewMenu(res_Id: number) {
    this.router.navigate(['/menu', res_Id]); 
  }
